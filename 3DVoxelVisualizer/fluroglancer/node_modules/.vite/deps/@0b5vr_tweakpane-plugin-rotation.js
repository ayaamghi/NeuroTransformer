...
// node_modules/@0b5vr/tweakpane-plugin-rotation/dist/tweakpane-plugin-rotation.js
...
var Euler = class _Euler extends Rotation {
  static fromQuaternion(quat, order, unit) {
    ...
    return new _Euler(...result, order).reunit(unit);
  }
  ...
  reunit(unit) {
    ...
    return new _Euler(prev2Next * this.x, prev2Next * this.y, prev2Next * this.z, this.order, unit);
  }
};
var Quaternion = class _Quaternion extends Rotation {
  static fromAxisAngle(axis, angle) {
    const halfAngle = angle / 2;
    const sinHalfAngle = Math.sin(halfAngle);
    return new _Quaternion(axis.x * sinHalfAngle, axis.y * sinHalfAngle, axis.z * sinHalfAngle, Math.cos(halfAngle));
  }
  ...
  static lookRotation(look, up) {
    ...
    if (trace > 0) {
      ...
      return new _Quaternion((m32 - m23) * s, (m13 - m31) * s, (m21 - m12) * s, 0.25 / s);
    } else if (m11 > m22 && m11 > m33) {
      const s = 2 * Math.sqrt(1 + m11 - m22 - m33);
      return new _Quaternion(0.25 * s, (m12 + m21) / s, (m13 + m31) / s, (m32 - m23) / s);
    } else if (m22 > m33) {
      const s = 2 * Math.sqrt(1 + m22 - m11 - m33);
      return new _Quaternion((m12 + m21) / s, 0.25 * s, (m23 + m32) / s, (m13 - m31) / s);
    } else {
      const s = 2 * Math.sqrt(1 + m33 - m11 - m22);
      return new _Quaternion((m13 + m31) / s, (m23 + m32) / s, 0.25 * s, (m21 - m12) / s);
    }
  }
  constructor(x, y, z, w) {
    super();
  ...
  get normalized() {
    ...
    return new _Quaternion(this.x / l, this.y / l, this.z / l, this.w / l);
  }
  get negated() {
  ...
  multiply(br) {
    const b = br.quat;
    return new _Quaternion(this.w * b.x + this.x * b.w + this.y * b.z - this.z * b.y, this.w * b.y - this.x * b.z + this.y * b.w + this.z * b.x, this.w * b.z + this.x * b.y - this.y * b.x + this.z * b.w, this.w * b.w - this.x * b.x - this.y * b.y - this.z * b.z);
  }
  format(r) {
    return r.quat;
  }
  slerp(br, t) {
    ...
    if (sqrSinHalfTheta <= Number.EPSILON) {
      const s = 1 - t;
      return new _Quaternion(s * a.x + t * b.x, s * a.y + t * b.y, s * a.z + t * b.z, s * a.w + t * b.w).normalized;
    }
    const sinHalfTheta = Math.sqrt(sqrSinHalfTheta);
    const halfTheta = Math.atan2(sinHalfTheta, cosHalfTheta);
    const ratioA = Math.sin((1 - t) * halfTheta) / sinHalfTheta;
    const ratioB = Math.sin(t * halfTheta) / sinHalfTheta;
    return new _Quaternion(a.x * ratioA + b.x * ratioB, a.y * ratioA + b.y * ratioB, a.z * ratioA + b.z * ratioB, a.w * ratioA + b.w * ratioB);
  }
  toMat3() {
    const { x, y, z, w } = this;
    return [
...
var Vector3 = class _Vector3 {
  ...
  get normalized() {
    ...
    return new _Vector3(this.x / l, this.y / l, this.z / l);
  }
  get negated() {
  ...
  orthoNormalize(tangent) {
    ...
    if (dotNT === 1) {
      if (Math.abs(normal.y) > Math.abs(normal.z)) {
        tangent = new _Vector3(0, 0, 1);
      } else {
        tangent = new _Vector3(0, 1, 0);
      }
  ...
  applyQuaternion(q) {
    ...
    return new _Vector3(ix * q.w + iw * -q.x + iy * -q.z - iz * -q.y, iy * q.w + iw * -q.y + iz * -q.x - ix * -q.z, iz * q.w + iw * -q.z + ix * -q.y - iy * -q.x);
  }
};
...
var className$2 = ClassName("rotationgizmo");
var VEC3_ZERO = new Vector3(0, 0, 0);
var VEC3_XP$2 = new Vector3(1, 0, 0);
var VEC3_YP$2 = new Vector3(0, 1, 0);
var VEC3_ZP$2 = new Vector3(0, 0, 1);
var VEC3_ZN = new Vector3(0, 0, -1);
var VEC3_XP70 = new Vector3(0.7, 0, 0);
var VEC3_YP70 = new Vector3(0, 0.7, 0);
var VEC3_ZP70 = new Vector3(0, 0, 0.7);
var VEC3_XN70 = new Vector3(-0.7, 0, 0);
var VEC3_YN70 = new Vector3(0, -0.7, 0);
var VEC3_ZN70 = new Vector3(0, 0, -0.7);
var QUAT_IDENTITY$2 = new Quaternion(0, 0, 0, 1);
...
var RotationInputGizmoView = class {
  get xArcBElement() {
  ...
  constructor(doc, config) {
    ...
    if (config.pickerLayout === "popup") {
      this.element.classList.add(className$2(void 0, "p"));
    }
    const padElem = doc.createElement("div");
...
var VEC3_XP$1 = new Vector3(1, 0, 0);
var VEC3_YP$1 = new Vector3(0, 1, 0);
var VEC3_ZP$1 = new Vector3(0, 0, 1);
var QUAT_IDENTITY$1 = new Quaternion(0, 0, 0, 1);
var QUAT_TOP = new Quaternion(INV_SQRT2, 0, 0, INV_SQRT2);
var QUAT_RIGHT = new Quaternion(0, -INV_SQRT2, 0, INV_SQRT2);
var QUAT_BOTTOM = new Quaternion(-INV_SQRT2, 0, 0, INV_SQRT2);
var QUAT_LEFT = new Quaternion(0, INV_SQRT2, 0, INV_SQRT2);
var QUAT_BACK = new Quaternion(0, 1, 0, 0);
var RotationInputGizmoController = class {
  constructor(doc, config) {
    this.onPadKeyDown_ = this.onPadKeyDown_.bind(this);
    this.onPointerDown_ = this.onPointerDown_.bind(this);
    this.onPointerMove_ = this.onPointerMove_.bind(this);
  ...
  onPadKeyDown_(ev) {
    ...
    const y = getStepForKey(1, getVerticalStepKeys(ev));
    if (x !== 0 || y !== 0) {
      const axis = new Vector3(-y, x, 0);
...
var className$1 = ClassName("rotationswatch");
var VEC3_XP = new Vector3(1, 0, 0);
var VEC3_YP = new Vector3(0, 1, 0);
var VEC3_ZP = new Vector3(0, 0, 1);
var QUAT_IDENTITY = new Quaternion(0, 0, 0, 1);
var RotationInputSwatchView = class {
  constructor(doc, config) {
    this.onValueChange_ = this.onValueChange_.bind(this);
    config.value.emitter.on("change", this.onValueChange_);
    this.value = config.value;
...
var RotationInputSwatchController = class {
  constructor(doc, config) {
    this.value = config.value;
    this.viewProps = config.viewProps;
...
var className = ClassName("rotation");
var RotationInputView = class {
  constructor(doc, config) {
    this.element = doc.createElement("div");
    this.element.classList.add(className());
    config.foldable.bindExpandedClass(this.element, className(void 0, "expanded"));
    bindValueMap(config.foldable, "completed", valueToClassName(this.element, className(void 0, "cpl")));
...
var RotationInputController = class {
  constructor(doc, config) {
    this.onButtonBlur_ = this.onButtonBlur_.bind(this);
    this.onButtonClick_ = this.onButtonClick_.bind(this);
    this.onPopupChildBlur_ = this.onPopupChildBlur_.bind(this);
...
var RotationInputPluginEuler = createPlugin({
  id: "rotation",
  type: "input",
...
var RotationInputPluginQuaternion = createPlugin({
  id: "rotation",
  type: "input",
  accept(exValue, params) {
    const result = parseRecord(params, (p) => ({
...
//# sourceMappingURL=@0b5vr_tweakpane-plugin-rotation.js.map
